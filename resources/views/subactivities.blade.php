                                    ...
                                    <div class="container">
                                        <ul class="ul-project">
                                            ...
                                            <li>
                                                ...
                                                <div class="row alert alert-secondary col-md-12"
                                                     style=" margin: 0">
                                                    ...
                                                    <div id="worker_selected" class="col-md-12 p-2 mt-2">
                                                        <div id="{{$workers[0]->id}}" class="btn btn-primary">
                                                            <span>{{$workers[0]->name}}</span>&nbsp;
                                                            <i id="delete_worker" data-id="{{$workers[0]->id}}"
                                                               class="las la-times"></i>
                                                        </div>
                                                    </div>
                                                    <p id="worker_selected_error" class="alert alert-danger"
                                                       style="display: none"></p>
                                                </div>
                                            </li>
                                            <br>
