    ...
    <div class="header-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card shadow">
                        {{--<div class="card-header alert-secondary">Manager details</div>--}}
                        <div class="card-body">
                            @if(session('success'))
                        ...
                        <div class="text-center">
                            ...
                            <p><strong>{{$project->manageBy->name}}</strong><a href="#"><i
                                        class="las la-external-link-square-alt text-primary"></i></a></p>
                            <p class="paragraph-title shadow">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('subproject.add')}}" method="POST">
                                ...
                                <div>
                                    <input type="hidden" class="form-control" id="project" name="project" value="{{$project->id}}" required>
                                    {{--<p>Select project</p>
                                    <div>
